...
from tradingagents.agents.utils.agent_utils import build_analyst_prompt, build_instrument_context, get_language_instruction, get_news, run_react_loop
...
def create_social_media_analyst(llm):
    async def social_media_analyst_node(state):
        ...
        system_message = (
            get_prompt("social_media_analyst")
